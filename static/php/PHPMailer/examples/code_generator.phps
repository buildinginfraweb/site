...
try {
    if (isset($_POST["submit"]) && $_POST['submit'] == "Submit") {
        ...
        $mail->addAttachment('images/phpmailer_mini.png?v=1', 'phpmailer_mini.png?v=1'); // optional name
        $mail->addAttachment('images/phpmailer.png?v=1', 'phpmailer.png?v=1'); // optional name
        $example_code .= "\n\$mail->addAttachment('images/phpmailer_mini.png?v=1'," .
            "'phpmailer_mini.png?v=1');  // optional name";
        $example_code .= "\n\$mail->addAttachment('images/phpmailer.png?v=1', 'phpmailer.png?v=1');  // optional name";
