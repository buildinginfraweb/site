  ...
  <v-container pb-0>
    <v-layout mb-2>
      <v-flex class="grey--text text--darken-3  text-xs-center display-1">
        ...
        nós da <span class="primary--text font-weight-bold">Building Infra</span>
      </v-flex>
    </v-layout>
    <v-layout row wrap>
      <v-flex xs12 sm4 md4 style="opacity: 0.6" class="hidden-sm-and-down">
        <v-carousel  height="360" v-model="first" hide-controls hide-delimiters class="elevation-0" reverse>
      ...
      <v-flex xs12 md4>
        <v-carousel  height="360" v-model="second" hide-controls hide-delimiters class="elevation-0" reverse>
          <v-carousel-item v-for="(client, index) in comments" :key="index">
            <v-container>
              <v-layout>
                <v-spacer></v-spacer>
      ...
      <v-flex xs12 sm4 md4 class="hidden-sm-and-down" style="opacity: 0.6">
        <v-carousel  height="360" v-model="third" hide-controls hide-delimiters class="elevation-0" reverse>
          <v-carousel-item v-for="(client, index) in comments" :key="index">
            <v-container>
              <v-layout>
                <v-spacer></v-spacer>
